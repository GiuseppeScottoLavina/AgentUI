                ...
                <table class="au-datatable-table">
                    <thead>
                        <tr>
                            ...
                            `:""}
                            ${n(a.map((c)=>{let u=c.sortable!==!1&&this.sortable,g=this._sortField===c.field,m=g?this._sortDirection==="asc"?"↑":"↓":"↕";return r`
                                    <th 
                                        class="${u?"au-datatable-sortable":""} ${g?"au-datatable-sorted":""}"
                                        data-field="${c.field}"
                                    >
                                        ${c.label||c.field}
                                        ${u?n(`<span class="au-datatable-sort-icon">${m}</span>`):""}
                                    </th>
                                `}).join(""))}
                        </tr>
                    </thead>
