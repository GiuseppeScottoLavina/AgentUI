import{i as r,j as o,m as a}from"./chunk-afwem87e.js";class i extends r{static baseClass="au-api-table";static observedAttributes=["type"];render(){let s=this.attr("type","attributes"),t=Array.from(this.querySelectorAll("au-api-row")),d={attributes:["Name","Type","Default","Description"],properties:["Name","Type","Description"],methods:["Name","Signature","Description"],events:["Name","Detail","Description"],tokens:["Token","Default","Description"]},c=d[s]||d.attributes,n=t.map((e)=>({name:e.getAttribute("name")||"",type:e.getAttribute("type")||"",default:e.getAttribute("default")||"-",signature:e.getAttribute("signature")||"",detail:e.getAttribute("detail")||"",description:e.textContent.trim()}));this.innerHTML=`
            <table class="au-api-table__table">
                <thead>
                    <tr>
                        ${c.map((e)=>`<th>${e}</th>`).join("")}
                    </tr>
                </thead>
                <tbody>
                    ${n.map((e)=>this.#t(s,e)).join("")}
                </tbody>
            </table>
